...
class FeatureStoreService:
    ...
    def get_data_from_hive(self, table: str) -> pd.DataFrame:
        ...
        try:
            with self.get_hive_connection() as conn:
                cursor = conn.cursor()
    ...
    def generate_report(self, table: str, online: bool) -> bool:
        ...
        try:
            ...
            json_path = os.path.join(settings.LOCAL_DIR, f"{id_name}.json")
    ...
    def upload_json_file(self, table: str) -> bool:
        ...
        try:
            ...
            url = f"{settings.URL2}{id_name}/dataprep"

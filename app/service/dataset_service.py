...
class DatasetService:
    ...
    def download_file(self, file_id: str, file_type: str) -> bool:
        ...
        url = f"{settings.URL}{file_id}/download2"
        file_path = os.path.join(settings.LOCAL_DIR, f"{file_id}.{file_type}")
    ...
    def _generate_and_save_report(
        ...
        try:
            ...
            json_path = os.path.join(settings.LOCAL_DIR, f"{file_id}_{identifier}.json")
    ...
    def upload_json_files(self, file_id: str, file_type: str) -> bool:
        ...
        try:
            json_files = [
                ...
                for root, dirs, files in os.walk(settings.LOCAL_DIR)
                for file in files
            ...
            for json_path in json_files:
                url = f"{settings.URL}{file_id}/upload-dataprep"

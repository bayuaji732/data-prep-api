...
from ..api.models import (
    ...
    FeatureGroupRequest, FeatureGroupResponse,
    TrainingDatasetRequest, TrainingDatasetResponse, TrainingDatasetBatchRequest
)
from ..service.dataset_service import DatasetService
from ..service.feature_store_service import FeatureStoreService
from ..service.training_dataset_service import TrainingDatasetService
...
async def process_feature_group(
    ...
    try:
        ...
        background_tasks.add_task(
            feature_store_service.process_single_feature_group,
            request.table_name,
            request.online
        )
...
async def batch_process_feature_groups(background_tasks: BackgroundTasks):
    ...
    try:
        ...
        feature_store_service = FeatureStoreService()
        background_tasks.add_task(
            feature_store_service.process_batch_feature_groups
        )
